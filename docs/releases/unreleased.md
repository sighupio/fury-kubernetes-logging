...
|-------------------------|---------------------------------------------------------------------------------------------------------------|--------------------------------|
| `opensearch`            | [`v3.8.0`](https://github.com/opensearch-project/OpenSearch/releases/tag/3.7.0)                               | `v3.7.0`                       |
| `opensearch-dashboards` | [`v3.8.0`](https://github.com/opensearch-project/OpenSearch-Dashboards/releases/tag/3.7.0)                    | `v3.7.0`                       |
