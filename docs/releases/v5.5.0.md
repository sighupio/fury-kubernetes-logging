...
- **Dropped support for Kubernetes versions lower than 1.33**: this module now officially supports Kubernetes
  `1.33` and newer. Clusters running Kubernetes `1.32` or older are no longer supported and should be upgraded
  before upgrading to this module version.
