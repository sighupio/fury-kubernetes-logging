...
test-pytest-docker:
	docker run -w /test_dir -v $PWD:/test_dir quay.io/sighup/katalog:1.0.11_3 sh -c "pwd; ls ; flake8 --ignore=E501 katalog/tests/test.py; bash katalog/tests/pytest.sh; rm -rf .pytest_cache katalog/tests/__pycache__ ;"
test: test-1 test-3
